...
JUSTIFICATIONS_BOT_USERNAME = "clinicase_bot"  # Username del bot de justificaciones CLINICASE_BOT
...
def process_justification_text(text: str) -> Tuple[str, bool]:
    ...
    Salida: "<a href='https://t.me/clinicase_bot?start=just_123'>📚 Ver justificación CASO #3</a>"
    ...
    # Crear deep link al bot @clinicase_bot (CLINICASE_BOT)
    ...
    logger.info(f"✅ Convertido a deep link para @{JUSTIFICATIONS_BOT_USERNAME}: {deep_link}")
...
async def publicar_todo_activos(context: ContextTypes.DEFAULT_TYPE):
    ...
    return pubs, fails    return targets
