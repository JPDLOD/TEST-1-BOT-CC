...
# lo publica en PRINCIPAL (y BACKUP si esta ON) en el MISMO ORDEN, sin "Forwarded from...".
...
async def _cmd_cancelar(update: Update, context: ContextTypes.DEFAULT_TYPE, txt: str):
    ...
    # tambien aceptar si respondes al mensaje
    ...
    # Saca de cualquier lock de programacion
