...
Solo convierte enlaces a deep links del bot @JUST_CC_bot
"""
...
JUSTIFICATIONS_BOT_USERNAME = "JUST_CC_bot"
...
def process_justification_links(text: str) -> Tuple[str, List[InlineKeyboardButton]]:
    ...
    for pattern in patterns:
        ...
        for match in matches:
            ...
            deep_link = f"https://t.me/{JUSTIFICATIONS_BOT_USERNAME}?start=just_{message_id}"
